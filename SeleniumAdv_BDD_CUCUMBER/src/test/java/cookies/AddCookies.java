...
public class AddCookies {
  ...
  public void f() {
	 ...
	 /* WebDriverWait var1= new WebDriverWait(wd,10);
      ...
      //ADDING COOKIES----------------------------------------------------
	  Cookie name=new Cookie("aditya","aditya12345");
	  wd.manage().addCookie(name);
	  
	  File file1=new File("C:\\Users\\aditya_ku\\Documents\\addedcookies.data");
	  ...
	  //DELETING COOKIES----------------------------------------
	  wd.manage().deleteCookieNamed("aditya");
	  File f1=new File("C:\\Users\\aditya_ku\\Documents\\deletedcookies.data");
	  ...
	  try {
			...
			for(Cookie ck:wd.manage().getCookies()) {
				ba.write((ck.getName()+";"+ck.getDomain()+";"+ck.getPath()+";"+ck.getExpiry()+";"+ck.isSecure()+";"+ck.getValue()));
				ba.newLine();
			}
			ba.close();
			fa.close();
